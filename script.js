...
setTempF = (elem) => {
  let tempf = Math.floor((elem - 273) * 9/5 + 32);
...
setTempMin = (elem) => {
  document.getElementById("temp-min").innerHTML = "Temp. Min: "+ Math.floor(elem - 273) + "°C   /   " + Math.floor((elem - 273) * 9/5 + 32)+ "°F" ;
}
setTempMax = (elem) => {
  document.getElementById("temp-max").innerHTML = "Temp. Max: " + Math.floor(elem - 273) + "°C   /   " + Math.floor((elem - 273) * 9/5 + 32)+ "°F" ;
